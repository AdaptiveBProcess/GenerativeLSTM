...
class TimesOptimizer():
    ...
    def evaluate_logs(args):
        ...
        def evaluate(settings, data, sim_log):
            ...
            data['start_timestamp'] = data['start_timestamp'].dt.tz_localize('US/Eastern')
            data['end_timestamp'] = data['end_timestamp'].dt.tz_localize('US/Eastern')
            """
            sim_log['start_timestamp'] = pd.to_datetime(sim_log['start_timestamp'])
            sim_log['end_timestamp'] = pd.to_datetime(sim_log['end_timestamp'])
            
            sim_log['start_timestamp'] = sim_log['start_timestamp'].dt.tz_localize('US/Eastern')
            sim_log['end_timestamp'] = sim_log['end_timestamp'].dt.tz_localize('US/Eastern')            
