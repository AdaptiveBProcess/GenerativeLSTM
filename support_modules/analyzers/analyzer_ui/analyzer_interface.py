# -*- coding: utf-8 -*-
from support_modules.analyzers.analyzer_ui import menu as mn
from support_modules.analyzers.analyzer_ui import act_pchange as apc
from support_modules.analyzers.analyzer_ui import act_duration as adur
from support_modules.analyzers.analyzer_ui import resource_use as ruse
from support_modules.analyzers.analyzer_ui import proc_duration as pdur
...
#def analyzer_interface(task_duration, percentual_change, process_duration):
#
#    app = AnalizerApp(task_duration, percentual_change, process_duration)
#    app.mainloop()
