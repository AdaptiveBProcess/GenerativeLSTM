"""
This module includes the adaptation of the work done by Sanderovich et. al in: 
A. Senderovich, C. Di Francescomarino, F.M. Maggi, 
From knowledge-driven to data-driven inter-case feature encoding
in predictive process monitoring,
Inf. Syst. 84 (2019) 255–264. doi:10.1016/j.is.2019.01.007.
...
if __name__ == "__main__":
    parameters = dict()
    try:
        opts, _ = getopt.getopt(sys.argv[1:], "hf:", ['file_name='])
        for opt, arg in opts:
        ...
        sys.exit(2)
    print(parameters)
    # parameters['file_name'] = 'inter_Helpdesk2.csv'
